...
class QLearningAgent:
  ...
  def act(self, observe, reward, done):
    ...
    if self.train and self.last_state:
      ...
      self.Q[self.last_state, self.last_action] = (1-self.alpha)*self.Q[self.last_state, self.last_action] + self.alpha*(reward + self.gamma*self.Q[current_state, current_action])
